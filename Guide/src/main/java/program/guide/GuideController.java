...
public class GuideController implements Initializable {
    ...
    public void publishGuide() {
        ...
        jsonHandler.writeGuideToJson(guideLocationChoice.getValue().toString(), guideDate.getValue().toString(), guideTimeChoice.getValue().toString(), guidePriceChoice.getValue().toString(), guideDescription.getText());
